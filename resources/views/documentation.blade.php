    ...
    <div class="container">
        ...
        <ul>
            ...
            <li>
                ...
                <p><code class="code">/api/players?removed=1&position=Center&nationality=USA</code>
                <p>
            </li>
            <li>
                ...
                <ul>
                    <li>
                        <p><span class="bold">Code:</span> 200</p>
                    </li>
    ...
    <span class="json-key">"errors"</span>: {
        ...
        <span class="json-key">"nationality"</span>: [<span class="json-str">"The selected nationality is invalid."</span>]
            ...
            <li>
                ...
                <ul>
                    <li>
                        <p><span class="bold">JavaScript</span> (<code>`fetch`</code>):</p>
                    </li>
